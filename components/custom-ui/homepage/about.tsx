...
export default function About() {
    return (
        <section className="w-full max-w-4xl mx-auto py-14 px-4">
            <Image
                src="/hero.jpg"
                alt="Class group"
                className="w-full h-40 object-cover object-top rounded-xl mb-8 shadow-md border border-gray-100"
                width={600}
                height={800}
            />
            <h2 className="font-bold text-2xl md:text-3xl mb-4 text-blue-700 flex items-center gap-2">
                <span role="img" aria-label="document">��</span> About <span className="font-script italic">ClassConnect</span>
            </h2>
            <div className="mb-5">
                <h3 className="text-lg font-semibold mb-1 text-gray-700 flex items-center gap-2">
