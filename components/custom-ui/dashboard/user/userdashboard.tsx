        ...
        <div className="min-h-screen    ">
            <section className="py-8">
                <div className="mx-auto max-w-7xl px-4 space-y-2 text-center">
                    <h1 className="text-2xl font-bold tracking-tight sm:text-3xl text-blue-700 drop-shadow-lg">Your Classmates</h1>
                    <p className="mx-auto max-w-md text-gray-700 text-base">
            ...
            <div className="mx-auto max-w-7xl px-4 pb-12">
                {filteredClassmates.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-8 items-stretch">
...
function PolaroidCard({ classmate }: PolaroidCardProps) {
    ...
    return (
        <div className="group relative overflow-hidden rounded-lg   text-gray-900  hover:shadow-md transition-all duration-300 w-full flex flex-col" style={{ minHeight: 370, maxHeight: 370 }}>
